...
public class Store {
	...
	private static Map<String, String> backMap = new HashMap<String, String>();
	private static Map<String, String> frontMap = new HashMap<String, String>();
	...
	public  static void  mapJsp(){
		...
		if(file.isDirectory()){
			...
			for(String f : files){
				if(f.indexOf(".jsp")!=-1){
					frontMap.put("/" + f, "Servlet." + f.substring(0, f.indexOf(".")));
				}
			}
		}
	}
